...
const OurWork = () => {
  return (
    <>
        <div className='bg-[#110F0F] w-[100vw] h-auto py-[80px] px-[40px] flex justify-center items-start flex-wrap gap-[40px] '>
            <div className='flex flex-col justify-center items:center  gap-[20px] w-[500px]'>
                <h1 className='font-bold text-[32px] sm:text-[34px]'>Some Pieces of Our Work</h1>
                <p className=' whitespace-normal text-[14px] sm:text-[16px]'>Risus commodo id odio turpis pharetra elementum. Pulvinar porta porta feugiat scelerisque in elit. Morbi rhoncus, tellus, eros consequat magna semper orci a tincidunt. </p>
                <button className="w-[100%] sm:w-[150px] px-[14px] py-[8px] sm:px-[16px] sm:py-[8px] rounded-[100px] text-[#FFA800] border-[#FFA800] border-[1.5px]">
                  Show More
                </button>
            </div>
